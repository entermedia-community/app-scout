...
public class SiteMapperIndex extends BaseLuceneSearcher
{
	private static final Log log = LogFactory.getLog(SiteMapperIndex.class);
	...
	public void reIndexAll(IndexWriter writer)
	{
		...
		File settingsFile = new File(getRootDirectory(), "/sitemap.xml");
	...
	private void newMap(File config) throws Exception
	{
